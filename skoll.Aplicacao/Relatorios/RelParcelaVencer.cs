...
{
    public class RelParcelaVencer : TNEReport
    {
        public List<RelParcelasVencer> list = null;
        public RelParcelaVencer()
        { 
            Paisagem = false;
        }

        public RelParcelaVencer(List<RelParcelasVencer> result)
        {
            Paisagem = false;
            this.list = result;
        }
